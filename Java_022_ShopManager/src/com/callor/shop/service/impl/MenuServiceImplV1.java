...
/*
 * impl 접미사 : 인터페이스를 implements 하여 생성한 클래스다.
 */
public class MenuServiceImplV1 implements MenuService {
	/*
	 * final 키워드는 변수, 객체를 혹시모를 어디선가 변경하는 행위를 못하도록 방지하는 조치 상수선언이라고 한다. final로 선언된 변수나
	 * 객체는 읽기 전용이다.
	 * 
	...
	public Integer selectMenu() {
		...
		while (true) {
			 ...
			 * if(intMenu >= 1 && intMenu <= 3) { return intMenu; } 
